...
![](https://cdn.jsdelivr.net/gh/linzhaopu/dolimima-img/20220806175829.png)
...
![](https://cdn.jsdelivr.net/gh/linzhaopu/dolimima-img/20220806223128.png)
...
![](https://cdn.jsdelivr.net/gh/linzhaopu/dolimima-img/20220806175837.png)

网络层最常使用的是 IP 协议（Internet Protocol），IP 协议会将传输层的报文作为数据部分，再加上 IP 包头组装成 IP 报文，如果 IP 报文大小超过 MTU（以太网中一般为 1500 字节）就会再次进行分片，得到一个即将发送到网络的 IP 报文。

![](https://cdn.jsdelivr.net/gh/linzhaopu/dolimima-img/20220806175844.png)
...
![](https://cdn.jsdelivr.net/gh/linzhaopu/dolimima-img/20220806175856.png)

将 255.255.255.0 取反后与 IP 地址进行进行按位与运算，就可以得到主机号。

大家可以去搜索下子网掩码计算器，自己改变下「掩码位」的数值，就能体会到子网掩码的作用了。

![](https://cdn.jsdelivr.net/gh/linzhaopu/dolimima-img/20220806175902.png)
...
![](https://cdn.jsdelivr.net/gh/linzhaopu/dolimima-img/20220806175907.png)
...
![](https://cdn.jsdelivr.net/gh/linzhaopu/dolimima-img/20220806175914.png)
...
![](https://cdn.jsdelivr.net/gh/linzhaopu/dolimima-img/20220806175926.png)
再给大家贴一下每一层的封装格式：

![](https://cdn.jsdelivr.net/gh/linzhaopu/dolimima-img/20220806175933.png)
